...
- `examples/v1/basic-local/index.html`
- `examples/v1/remote-registry/index.html`
- `examples/v1/agentic-app/index.html`
- `examples/v1/agentic-support-triage/index.html`
- `examples/v1/agentic-approval-workflow/index.html`
- `examples/v1/agentic-signals/index.html`
- `examples/v1/router-machine/index.html`
- `examples/v1/form-machine/index.html`
