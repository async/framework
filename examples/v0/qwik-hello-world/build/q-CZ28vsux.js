const T = (E, q) => {
  const t = window,
    ...
    f = "_qCityInitScroll";
  if (!t[l] && !t[u] && !t[d] && !t[y] && !t[f]) {
    const _ = location.pathname + location.search,
      m = "_qCityHistoryPatch",
      C = "_qCityBootstrap",
      s = "_qCityScrollEnabled",
      a = "_qCityScrollDebounce",
      S = "_qCityScroll",
      g = (o) => {
    ...
    if (
        ...
        t[u] = () => {
          ...
          if (!t[l]) {
            if (
              ...
              const r = (i) => i.closest("[q\\:container]"),
                e = (o = r(q)) == null
                  ? void 0
                  : o.querySelector("a[q\\:link]");
              if (e) {
                const i = r(e), c = e.cloneNode();
                c.setAttribute("q:nbs", ""),
              ...
              const r = (n = history.state) == null ? void 0 : n[S];
              g(r), t[s] = !0;
            }
          }
        },
      ...
      const o = history.pushState,
        ...
        r = (
          ...
          e);
      history.pushState = (e, i, c) => (e = r(e), o.call(history, e, i, c)),
        history.replaceState = (
          e,
          i,
          c,
        ) => (e = r(e), n.call(history, e, i, c));
    }
    t[d] = (o) => {
      if (t[l] || o.defaultPrevented) return;
      ...
      if (n && !n.hasAttribute("preventdefault:click")) {
        const r = n.getAttribute("href"),
          ...
          i = new URL(r, e),
          c = i.origin === e.origin,
          v = i.pathname + i.search === e.pathname + e.search;
        if (c && v) {
          if (
            o.preventDefault(),
            ...
            const w = i.hash.slice(1), b = document.getElementById(w);
            b && b.scrollIntoView();
          }
        }
      }
      ...
      t[y] = () => {
        !t[l] && t[s] && document.visibilityState === "hidden" && h();
      },
      t[f] = () => {
        t[l] || !t[s] || (clearTimeout(t[a]),
          t[a] = setTimeout(() => {
            h(), t[a] = void 0;
          }, 200));
      },
      ...
      setTimeout(() => {
        addEventListener("popstate", t[u]),
          ...
          t.navigation ||
          document.addEventListener("visibilitychange", t[y], { passive: !0 });
      }, 0);
  }
};
export { T as s_gNwUJOjjmEc };
