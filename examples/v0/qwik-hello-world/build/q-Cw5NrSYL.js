import { _ as e } from "./q-DwB5CxdB.js";
import {
  F as l,
  f as a,
  g as r,
...
const s =
  ...
  x = a(
    i(
      () => e(() => import("./q-CCKrurEM.js").then((o) => o.f), []),
      "s_u0bwM0i5dA8",
    ),
  ),
  c = a(i(() => e(() => import("./q-DT_NZ9Fj.js"), []), "s_mBt9fIl89mc")),
  f = () => (n(
    i(
      () => e(() => Promise.resolve().then(() => g), void 0),
      "s_JKHgMZ4xLZQ",
    ),
  ),
    t(
      l,
      {
        children: [
          t(c, null, 3, "XF_0"),
          r("main", null, null, t(p, null, 3, "XF_1"), 1, null),
          t(x, null, 3, "XF_2"),
        ],
      },
      1,
...
export { d as s_JKHgMZ4xLZQ, f as s };
