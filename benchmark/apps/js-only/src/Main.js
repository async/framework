...
rowTemplate.innerHTML =
  "<td class='w-16 px-3 py-2 text-slate-500'> </td><td class='w-1/3 px-3 py-2'><a class='text-sky-700 hover:text-sky-900'> </a></td><td class='px-3 py-2'><a class='inline-flex h-7 w-7 items-center justify-center rounded border border-rose-200 text-rose-700 hover:border-rose-300 hover:text-rose-900'><span aria-hidden='true'>x</span></a></td><td class='px-3 py-2'></td>";
