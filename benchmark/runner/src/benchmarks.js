export const DEFAULT_FRAMEWORKS = ["js-only", "react", "qwik-v1", "qwik-v2", "solid-v1", "solid-v2"];
...
export const BENCHMARKS = [
  ...
  },
  {
    ...
    async init(page) {
      ...
      await expectClass(page, "tbody>tr:nth-of-type(5)", "is-selected");
    },
    async run(page) {
      await click(page, rowLabelSelector(2));
      await expectClass(page, "tbody>tr:nth-of-type(2)", "is-selected");
    },
  },
  {
    id: "05_swap1k",
